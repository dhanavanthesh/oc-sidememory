from oc_sidememory import Guide
...
try:
    ...
    raise ImportError(
        f"To use the kernels in `oc_sidememory.kernels.numpy`, `{missing_dep}` must be installed. You can install it with `pip install {missing_dep}`"
    ) from e
