...
//!
//! // Build a small local vocabulary. Model loading is available behind the Hub feature.
//! let mut vocabulary = Vocabulary::new(2);
//! vocabulary.try_insert(b"0".to_vec(), 0)?;
//! vocabulary.try_insert(b"1".to_vec(), 1)?;
//!
